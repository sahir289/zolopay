              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3.5 gap-x-4">
                  {_.take(files.fakeFiles(), 3).map((faker, fakerKey) => (
                    <div key={fakerKey}>
                      <div className="flex items-center relative px-3 py-2.5 rounded-[0.6rem] border border-slate-200/80 hover:bg-slate-50 cursor-pointer transition sm:px-5 shadow-sm dark:hover:bg-darkmode-400">
                        <div className="">
                          <FormCheck.Input
                        ...
                        <div className="flex flex-col w-full ml-3 lg:items-center lg:flex-row gap-y-1">
                          ...
                          <div className="mr-4 text-xs lg:text-center lg:ml-auto text-slate-500/80 dark:text-slate-400">
