                  ...
                  <div className="flex flex-col gap-y-7">
                            ...
                            (faker, fakerKey) => (
                              ...
                              >
                                ...
                                >
                                  ...
                                  {faker.images && (
                                    <div className="sm:w-1/2 my-3.5 p-1 border rounded-[0.6rem] bg-slate-50/80 dark:bg-darkmode-400">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-10 gap-x-6">
                      <div className="flex flex-col p-5 box box--stacked">
                        ...
                        <Button
                          variant="primary"
                          className="w-full mt-5 bg-white border-dashed text-primary border-primary/20 hover:bg-primary/20 dark:bg-darkmode-400"
                        >
                          View All Messages
                          <Lucide
                            icon="ArrowRight"
                    ...
                    <div className="flex flex-col box box--stacked">
                      ...
                      <div className="p-5">
                        <Button
                          variant="primary"
                          className="w-full bg-white border-dashed text-primary border-primary/20 hover:bg-primary/20 dark:bg-darkmode-400"
                        >
                          View All Projects
                          <Lucide
                            icon="ArrowRight"
                  ...
                  <div className="sticky flex flex-col top-[6.2rem] gap-y-7">
                    <div className="flex flex-col p-5 box box--stacked">
                      ...
                      <div className="flex h-2 mt-3.5">
                        ...
                        <div className="h-full first:rounded-l last:rounded-r border border-slate-300 bg-slate-100 w-[40%] dark:bg-darkmode-400"></div>
                      </div>
                      <Button
                        variant="primary"
