      ...
      <div className="col-span-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          {calculationItems.map((item, index) => (
            <div
              key={index}
              className={`p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow ${item.color}`}
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
          <div className="p-6 bg-green-100 text-green-700 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <Lucide icon="DollarSign" className="w-10 h-10 mb-4" />
            <h3 className="text-lg font-semibold">Current Balance</h3>
            <p className="text-2xl font-bold">₹{currentBalance}</p>
          </div>
          <div className="p-6 bg-blue-100 text-blue-700 rounded-lg shadow-md hover:shadow-lg transition-shadow">
