    ...
    const projects: Array<Project> = [
      {
        ...
        projectManager: users.fakeUsers()[0] || { name: '', position: '', photo: '', email: '', phone: '', department: '', location: '', joinedDate: '', manager: '', addressLine1: '', addressLine2: '', isActive: false },
        creativeDirector: users.fakeUsers()[0] || { name: '', position: '', photo: '', email: '', phone: '', department: '', location: '', joinedDate: '', manager: '', addressLine1: '', addressLine2: '', isActive: false },
        dueDate: dayjs
