...
import PayInComponent from '@/pages/TransactionList/Payin/CompletedPayin/payin';
...
function Main() {
  ...
  const [title, setTitle] = useState('Deposits');
        ...
        <div className="col-span-12">
          <div className="p-3 sm:p-4 md:p-5 box box--stacked">
            ...
            >
              ...
              <Tab.Panels className="border-b border-l border-r border-gray-100 ">
